...
В `opencode.json` будут добавлены MCP-сервер и LLM-провайдер `tropass` с моделями `Qwen3.5-397B-A17B-FP8` и `GLM-5.2`. Моделью по умолчанию станет `tropass/Qwen3.5-397B-A17B-FP8`. Остальные разделы конфигурации сохранятся.
